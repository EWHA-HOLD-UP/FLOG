...
class _QpuzzleScreenState extends State<QpuzzleScreen> {
  ...
  int tempCellIndex = -1;
  late bool
      ongoing; //진행중(=나는 답변 완료했으나 가족 모두 답변 완료하지는 x) -> 답변 완료 후 나는 답변하는 화면이 아닌 가족들의 답변 여부 볼 수 있어야 하므로 필요
  int puzzleno = 0;
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, groupSnapshot) {
          ...
          if (groupDocuments.isNotEmpty) {
            final unlockList = groupDocuments[0]['unlock'] as List<
                dynamic>; //unlockList의 각 요소를 bool로 변환하여 unlockStates에 추가
            unlockStates.clear(); //기존 데이터 지우기
            unlockStates
                .addAll(unlockList.map((dynamic value) => value as bool));
            selectedCellIndex = groupDocuments[0]
                ['selectedIndex']; //selectedIndex 파이어베이스에서 가져오기
            //isAnyFamilyMemberOngoing = groupDocuments[0]['isAnyFamilyMemberOngoing'];
          }

          return StreamBuilder<QuerySnapshot>(
            stream:
                FirebaseFirestore.instance.collection('Qpuzzle').snapshots(),
                        ...
                        children: [
                          ...
                          if (qpuzzleUrl != null) //qpuzzleUrl이 있을 때 !! 이미지를 표시
                            Stack(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  isQuestionSheetShowed =
                                                      userSnapshot[
                                                          ...
                                                          as bool;
                                                  isAnswered =
                                                      userSnapshot['isAnswered']
                                                          as bool;
                                                  if (ongoing == true) {
                                                    isAnyFamilyMemberOngoing =
                                                        true;
                                                  ...
                                                  if (unlockStates[
                                                    ...
                                                    showModalBottomSheet(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      ListView
                                                                        ...
                                                                        itemBuilder:
                                                                            (context,
                                                                                rowIndex) {
                                                                          final userData = userDocuments[rowIndex].data() as Map<
                                                                              String,
                                                                              dynamic>;
                                                                          final userProfile =
                                                                              userData['profile'];
                                                                          final userNickname =
                                                                              userData['nickname'];
                                                                          //각 사용자에 대한 답변을 불러오기
                                                                          final answerCollection = FirebaseFirestore
                                                                              .instance
                                                                              .collection('Answer');
                                                      ...
                                                      selectedCellIndex ==
                                                              row * 2 + col &&
                                                          ongoing == false) {
                                                    //현재 그 조각을 선택하고 있다면 (아직 답변x이지만 그 조각 이전에 이미 선택중인 상태, 질문창 봤을수 있음)
                                                    ...
                                                    userRef.update({
                                                      'isQuestionSheetShowed':
                                                        ...
                                                        .then((_) {
                                                      print(
                                                          'isQuestionSheetShowed 상태가 Firebase Firestore에 업데이트되었습니다.');
                                                    }).catchError((error) {
                                                      print(
                                                          'isQuestionSheetShowed 상태 업데이트 중 오류 발생: $error');
                                                    });
                                                    isAnyFamilyMemberShowedQsheet =
                                                        true;
                                                    FirebaseFirestore.instance
                                                    ...
                                                    setState(() {
                                                      selectedCellIndex = row *
                                                              2 +
                                                          col; //그리고 선택한 조각의 인덱스로 selectedCellIndex 변경
                                                      ...
                                                      userRef.update({
                                                        'isAnswered': false
                                                          ...
                                                          .then((_) {
                                                        print(
                                                            'isAnswered 상태가 Firebase Firestore에 업데이트되었습니다.');
                                                      }).catchError((error) {
                                                        print(
                                                            'isAnswered 상태 업데이트 중 오류 발생: $error');
                                                      });
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    color: unlockStates[
                                                            row * 2 + col]
                                                        ? Colors
                                                            .transparent //unlock되면 투명해져서 사진이 드러남
                                                        : const Color(
                                                            0xFF000000),
                                                              ...
                                                              decoration:
                                                                ...
                                                                borderRadius:
                                                                  ...
                                                                  topRight: Radius.circular((row ==
                                                                      ...
                                                                      : 0.0),
                                                                  // 1행 2열
                                                                  bottomLeft: Radius.circular((row ==
                                                                              2 &&
                                                                          col ==
                                                                              0)
                                                                      ? 23.0
                                                                      : 0.0),
                                                                  // 3행 1열
                                                                  bottomRight: Radius.circular((row ==
                                                                              2 &&
                                                                          col ==
                                                                              1)
                                                                      ? 23.0
                              ...
                              null) // qpuzzleUrl이 없을 때!! 회색 상자와 + 버튼 표시
                            Container(
                              width: 330,
                              height: 495,
                              decoration: BoxDecoration(
                        ...
                        itemBuilder: (context, rowIndex) {
                          ...
                          return StreamBuilder<QuerySnapshot>(
                              ...
                              builder: (context, answerSnapshot) {
                                ...
                                final answerDocuments =
                                    answerSnapshot.data!.docs;
                                String userAnswer =
                                    "답변을 작성한 후 확인하세요"; // 변수를 이 부분에서 선언하고 초기화
                                if (isAnswered == true) {
                                  for (final answerDoc in answerDocuments) {
                                    final answers = answerDoc['answers']
                                        as Map<String, dynamic>;
                                    final userAnswerText =
                                        answers[userData['email']];
                                    if (userAnswerText != null) {
                                      userAnswer = userAnswerText;
                                      break;
                                    }
                                              ...
                                              child: InkWell(
                                                onTap: () async {
                                                  if (isSendButtonEnabled) {
                                                    setState(() {
                                                      isAnswered =
                                                          true; //전송 버튼 누르면 답변한 것
                                                      ongoing =
                                                          true; //나는 답변 완료했으므로 ongoing = true
                                                      ...
                                                      userRef.update({
                                                        ...
                                                        print(
                                                            'ongoing 상태가 Firebase Firestore에 업데이트되었습니다.');
                                                      }).catchError((error) {
                                                        print(
                                                            'ongoing 상태 업데이트 중 오류 발생: $error');
                                                      });
                                                    });
                                                    ...
                                                    query
                                                        .get()
                                                        .then((querySnapshot) {
                                                      final existingAnswerDocument =
                                                          querySnapshot
                                                              .docs.first;
                                                      Map<String, dynamic>
                                                          existingAnswers =
                                                          existingAnswerDocument[
                                                              'answers'];
                                                      existingAnswers[userData[
                                                          'email']] = myanswer;
                                                      ...
                                                      existingAnswerDocument
                                                        ...
                                                        print(
                                                            'Answer이 Firebase Firestore에 업데이트되었습니다.');
                                                      }).catchError((error) {
                                                        print(
                                                            'Answer 업데이트 중 오류 발생: $error');
                                                      });
                                                    });

                                                    //전체 가족 답변 여부 체크해서 result 변수에 담기 (전체 가족 답변 완료 시, true 저장)
                                                    final result =
                                                        await checkFamilystate();
                                                    ...
                                                    if (result == true) {
                                                      ...
                                                      setState(() {
                                                        answerController
                                                            .clear();
                                                        qpuzzleTitleController
                                                            .clear();
                                                        unlockStates[
                                                                selectedCellIndex] =
                                                            true; //해당 조각을 unlock 상태로 변경 (잠금 해제)
                                                        isQuestionSheetShowed =
                                                            false; //초기화
                                                        isAnyFamilyMemberOngoing =
                                                            false;
                                                      ...
                                                      groupRef.update({
                                                        ...
                                                        print(
                                                            'Unlock 상태가 Firebase Firestore에 업데이트되었습니다.');
                                                      }).catchError((error) {
                                                        print(
                                                      ...
                                                      if (unlockStates.every(
                                                        ...
                                                        FirebaseFirestore
                                                          ...
                                                          if (querySnapshot.docs
                                                            ...
                                                            docRef.update({
                                                              'isComplete':
                                                                  true, //Qpuzzle 컬렉션에서 isComplete 필드 반영
                                                              'qpuzzleUploader':
                                                                  "",
                                                              'qpuzzleTitle': ""
                                                            });
