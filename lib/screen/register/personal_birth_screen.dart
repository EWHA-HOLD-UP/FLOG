                    ...
                    ElevatedButton(
                      onPressed: isButtonEnabled
                          ? () {
                              ...
                              String enteredNickname = widget
                                  .nickname; //닉네임 저장된 변수 - 파이어베이스에 저장 + 셋팅 화면에서 활용하면 될 것 같음
                              String enteredBirth = birthController.text;

                              /* 하단 두개 변수를 파이어베이스에 저장 + 셋팅 화면에서 활용하면 될 것 같음 */
                              String enteredBirthMonth =
                                  enteredBirth.substring(0, 2); //월 저장된 변수
                              String enteredBirthDay =
                                  enteredBirth.substring(2); //일 저장된 변수
